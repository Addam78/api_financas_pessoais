# Graph Report - Api_FInanças  (2026-07-15)

## Corpus Check
- 26 files · ~2,756 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 146 nodes · 168 edges · 42 communities (8 shown, 34 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d423be95`
...
3. `loginController()` - 4 edges
4. `createTransactionController()` - 4 edges
5. `findTransactionController()` - 4 edges
6. `updateTransactionController()` - 4 edges
7. `deleteTransactionController()` - 4 edges
8. `createUserController()` - 4 edges
9. `transactionRoutes()` - 4 edges
10. `findTransactionRoutes()` - 4 edges
...
Cohesion: 0.13
Nodes (19): adapter, pool, prisma, createTransaction(), CreateTransactionData, deleteTransaction, findTransaction(), updateTransaction() (+11 more)

### Community 4 - "Auth Flow (Login)"
Cohesion: 0.33
Nodes (6): loginBodySchema, loginController(), loginSchema, findUserByEmail(), authRoutes(), authenticateUser()
...
Cohesion: 0.23
Nodes (8): createUserController(), createUserSchema, createUser, userRoutes(), app, createUserBodySchema, createUserService(), CreatUserRequest
...
- **Why does `prisma` connect `Prisma Client & DB Setup` to `Transaction Service & Repository`?**
